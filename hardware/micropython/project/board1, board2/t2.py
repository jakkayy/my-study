...
#             last_publish = now
        ...
        host, msg = e.recv()
        if msg:
#             if msg.decode() == str(key) or msg.decode() == switch:
#                 pass
            if msg.decode() == '1':
                key = 1
            elif msg.decode() == '0':
            ...
            if d1 <= 10 and dist > 10 and count == 0 and key == 0:
                ...
                set_servo_angle(110)
            elif d1 <= 10 and (dist > 10 or dist <= 10) and count == 0 and key == 1 and switch == 5:
                clear_green()
                count = 0
                red.value(1)
                display.text("stop", 50, 25)
...
#                 clear_oled()
                ...
                display.text("go", 50, 25)
                set_servo_angle(15)
            elif d1 <= 10 and dist <= 10 and (count == 0 or count != 0) and key == 1 and switch == 5:
                clear_green()
                count += 1
                red.value(1)
                display.text("stop", 50, 25)
